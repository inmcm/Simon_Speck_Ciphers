...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set Cipher_Settings [ipgui::add_page $IPINST -name "Cipher Settings"]
  ipgui::add_param $IPINST -name "KEY_SIZE" -parent ${Cipher_Settings} -widget comboBox
  ipgui::add_param $IPINST -name "BLOCK_SIZE" -parent ${Cipher_Settings} -widget comboBox
